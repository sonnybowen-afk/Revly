...
import { METHODS, methodById } from "@/lib/methods";
import { formatGbp, quantityLabel, quote, unitRateLabel } from "@/lib/pricing";
import type { BookingDraft, Errors, FieldName } from "@/lib/booking";
import {
  BOOKABLE_DAYS,
  EMPTY_DRAFT,
  NOTES_LIMIT,
