...
const SITE_LINKS = [
  { href: "/annie/services", label: "Services & prices" },
  { href: "/annie/hair-match", label: "Find my method" },
  { href: "/annie/gallery", label: "Gallery" },
  { href: "/annie/reviews", label: "Reviews" },
  { href: "/annie/about", label: "About Annie" },
  { href: "/annie/aftercare", label: "Aftercare" },
  { href: "/annie/contact", label: "Find us" },
  { href: "/annie/book", label: "Book a consultation" },
] as const;
