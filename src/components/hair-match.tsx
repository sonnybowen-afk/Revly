...
import type { Answers, Match } from "@/lib/hair-match";
import { confidence, rankMethods } from "@/lib/hair-match";
import { formatDurationRange } from "@/lib/pricing";
    ...
    <div>
      <div className="annie-card p-6 md:p-10">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <AnnieLink
            href={best ? `/book?method=${best.method.id}` : "/book"}
            arrow
          >
