...
import { Atmosphere, StrandField } from "@/components/atmosphere";
import { BeforeAfter } from "@/components/before-after";
import { CountUp } from "@/components/count-up";
import { Faq, FaqJsonLd } from "@/components/faq";
import { Marquee } from "@/components/marquee";
import { brief, photo } from "@/lib/photos";
import { Parallax, WordReveal } from "@/components/motion";
import { Reveal } from "@/components/reveal";
import { Stars } from "@/components/review-wall";
...
import { REVIEW_THEMES } from "@/lib/reviews";
import { ADDRESS_ONE_LINE, MAPS_URL, RATING, SALON } from "@/lib/salon";
import { formatDurationRange, formatGbp, unitRateLabel } from "@/lib/pricing";
        ...
        <div className="grid gap-16 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] lg:items-center">
          ...
          <Reveal delay={250}>
            <div className="mt-10 flex flex-wrap items-center gap-4">
              <AnnieLink href="/book" arrow>
                Book a free consultation
              </AnnieLink>
              <AnnieLink href="/hair-match" tone="outline">
  ...
  return (
    <AnnieSection id="methods">
      <div className="flex flex-wrap items-end justify-between gap-6">
        ...
        />
        <Reveal>
          <AnnieLink href="/services" tone="outline" arrow>
      ...
      <div className="mt-14 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Reveal direction="zoom" delay={METHODS.length * 70}>
          <article className="annie-card flex h-full flex-col justify-between bg-primary-soft/30 p-6">
            ...
            <AnnieLink href="/hair-match" className="mt-6 w-full" arrow>
              Find my method
            </AnnieLink>
          </article>
        </Reveal>
        ...
        <div className="mx-auto max-w-2xl text-center">
          <Reveal direction="zoom-out">
            ...
            <div className="mt-9 flex flex-wrap justify-center gap-4">
              ...
              <AnnieLink href="/services" tone="outline">
                Compare the costs
              </AnnieLink>
            </div>
          </Reveal>
  ...
  return (
    <AnnieSection tone="subtle">
      <div className="flex flex-wrap items-end justify-between gap-6">
        ...
        />
        <Reveal>
          <AnnieLink href="/gallery" tone="outline" arrow>
            See the gallery
          </AnnieLink>
        </Reveal>
      </div>
